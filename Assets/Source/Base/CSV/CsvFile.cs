...
public sealed class CsvRecord
{
    ...
    public int GetInt(int colum, int defaultValue)
    {
        string text = Fields[colum];
    ...
    public float GetFloat(int colum, float defaultValue)
    {
        string text = Fields[colum];
        if(string.IsNullOrEmpty(text))
        {
    ...
    public double GetDouble(int colum, double defaultValue)
    {
        string text = Fields[colum];
        if(string.IsNullOrEmpty(text))
        {
    ...
    public string GetString(int colum, string defaultValue)
    {
        string text = Fields[colum];
        if(string.IsNullOrEmpty(text))
        {
